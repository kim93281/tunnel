...
#include "../Tunnel_Image_Analyser/detector.h"
...
QT_MOC_LITERAL(1, 9, 10), // "SigSendLog"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "event"
QT_MOC_LITERAL(4, 27, 10) // "time_stamp"

    },
    "Detector\0SigSendLog\0\0event\0time_stamp"
};
...
void Detector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SigSendLog((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QTime(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Detector::*)(QString , QTime );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Detector::SigSendLog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Detector::SigSendLog(QString _t1, QTime _t2)
{
